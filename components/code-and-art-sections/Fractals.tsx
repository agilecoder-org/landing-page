  ...
  return (
    <div className="flex justify-center lg:h-[calc(100vh-200px)] lg:my-0 my-20 items-center">
      <div className="grid lg:grid-cols-2 gap-10 max-w-[1200px] w-full">
        <div>
          <h1 id="fractals" className="text-[4rem] font-fira font-semibold">Fractals</h1>
        ...
        <div className="flex flex-col relative min-h-[500px] justify-center items-center" ref={sketchRef}>
          {!restart && isVisible && (
            <P5Wrapper setup={sketch.setup} draw={sketch.draw} />
          )}

          <div className="md:bottom-[-20px] bottom-0 flex" style={{ position: 'absolute', cursor: "pointer" }}>
